...
?><div id="compositeSummary" class="composite_summary <?php echo esc_attr( $summary_classes ); ?>" data-columns="<?php echo esc_attr( $summary_columns ); ?>"><?php
	...
	if ( $product->get_composite_layout_style_variation() === 'componentized' ) {
		...
		?><h2 class="summary_title step_title_wrapper">Product overzicht</h2><?php
	}
