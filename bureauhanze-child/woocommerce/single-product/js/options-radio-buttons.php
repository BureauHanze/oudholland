		...
		<ul class="component_option_radio_buttons_container cp_clearfix" style="list-style:none">
			<# for ( var index = 0; index <= data.length - 1; index++ ) { #>
				<li id="component_option_radio_button_container_{{ data[ index ].option_suffix }}" class="component_option_radio_button_container {{ data[ index ].outer_classes }}">
					<!-- Add onclick for accessoires price -->
					<div onclick="setTimeout(function() { productTotal()}, 600); setTimeout(function() { watchSelections()}, 700)" id="component_option_radio_button_{{ data[ index ].option_suffix }}" class="cp_clearfix component_option_radio_button {{ data[ index ].inner_classes }}" data-val="{{ data[ index ].option_id }}">
						...
						<div class="radio_button_description">
							<h5 class="radio_button_title title"><span class="title_yes">Ja</span><span class="title_no">Nee</span></h5>							
