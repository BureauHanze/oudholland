...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
    <h4 class="cart_count_heading">Totalen winkelwagen</h4>
    <?php do_action('woocommerce_before_cart_totals'); ?>

    <div class="total_table">

        <div class="cart_subtotal">
            <div><?php esc_html_e('Subtotaal excl. btw', 'woocommerce'); ?></div>
            <div><?php echo wc_price(WC()->cart->get_subtotal()); ?></div>
        </div>
        <div class="cart_subtotal">
            <div><?php esc_html_e('21% btw', 'woocommerce'); ?></div>
            <div><?php echo wc_price(WC()->cart->get_subtotal_tax()); ?></div>
        </div>
